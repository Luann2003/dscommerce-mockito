...
public class OrderServiceTests {
	...
	@Test
	public void findByIdShouldReturnOrderDTOWhenIdExistingAndAdminLogged() {
	...
	@Test
	public void findByIdShouldReturnOrderDTOWhenIdExistingAndSelfLogged() {
		Mockito.doNothing().when(authService).validateSelfOrAdmin(any());
	...
	@Test
	public void findByIdShouldThrowsForbbidenExceptionWhenIdExistisAndOtherClientLogged() {
	...
	@SuppressWarnings("unused")
	@Test
	public void findByIdShouldThrowsResourceNotFoundExceptionWhenIdDoesNotExisting() {
		Mockito.doNothing().when(authService).validateSelfOrAdmin(any());
	...
	@Test
	public void insertShouldThorwsUsernameNotFoundExceptionWhenUserNotLogged() {
